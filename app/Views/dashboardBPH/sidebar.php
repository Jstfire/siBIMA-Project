...
<body id="body-pd">
    ...
    <div class="l-navbar" id="nav-bar">
        <nav class="nav">
            <div>
                <a href="<?php echo base_url(); ?>/DashboardBPH" class="nav_logo text-white">
                    <i class="fa-solid fa-layer-group"></i>
                    <span class="nav_logo-name">Dashboard BPH</span>
                </a>
                <div class="nav_list">
                    <?php
                ...
                ';
                    ...
                    ?>
                    <?php
                    if ($url == base_url() . '/DashboardBPH/ListProposal') {
                        echo '
                    <a href="' . base_url() . '/DashboardBPH/ListProposal" class="nav_link active">
                  ...
                  ';
                        ...
                        echo '
                    <a href="' . base_url() . '/DashboardBPH/ListProposal" class="nav_link">
                      <i class="fa-solid fa-list-ol"></i>
                      <span class="nav_name">List Proposal</span>
                    </a>
                  ';
                    ...
                    if ($url == base_url() . '/DashboardBPH/ListLPJ') {
                        echo '
                    <a href="' . base_url() . '/DashboardBPH/ListLPJ" class="nav_link active">
                  ...
                  ';
                        ...
                        echo '
                    <a href="' . base_url() . '/DashboardBPH/ListLPJ" class="nav_link">
                    <i class="fa-regular fa-clipboard"></i>
                      <span class="nav_name">List LPJ</span>
                    </a>
                  ';
